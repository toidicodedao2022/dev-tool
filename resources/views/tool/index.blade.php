            ...
            <div class="col-md-6">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col p-4 d-flex flex-column position-static">
                        <strong class="d-inline-block mb-2 text-primary">{{Arr::get($tool,'name')}}</strong>
                        <h3 class="mb-0 d-none">Featured post</h3>
                        <div class="mb-1 text-muted">{{Arr::get($tool,'created_at',date('Y-m-d'))}}</div>
                        <p class="card-text mb-auto">{{Arr::get($tool,'short_content')}}</p>
                        <span class="d-flex tool-action d-flex justify-content-around">
                            <span>
                                <i class="fa fa-eye" aria-hidden="true"></i>
                                {{Arr::get($tool,'count_use','0')}}
                            </span>
                            <span>
                                <i class="fa fa-heart-o" aria-hidden="true"></i>
                                {{Arr::get($tool,'count_like')}}
                            </span>
                            <span>
    ...
    <div class="row g-5">
        <div class="col-md-8">
            ...
            <article class="blog-post">
                ...
                <p>This blog post shows a few different types of content that’s supported and styled with Bootstrap. Basic typography, lists, tables,
                    images, code, and more are all supported as expected.</p>
                <hr>
                <p>This is some additional paragraph placeholder content. It has been written to fill the available space and show how a longer
                    snippet of text affects the surrounding content. We'll repeat it often to keep the demonstration flowing, so be on the lookout for
                ...
                <p>This is some additional paragraph placeholder content. It has been written to fill the available space and show how a longer
                    ...
                    this exact same string of text.</p>
                <h3>Example lists</h3>
                <p>This is some additional paragraph placeholder content. It's a slightly shorter version of the other highly repetitive body text
                    used throughout. This is an example unordered list:</p>
                <ul>
                ...
                <ul>
                    ...
                    <li>Superscript <sup>text</sup> uses <code class="language-plaintext highlighter-rouge">&lt;sup&gt;</code> and subscript
